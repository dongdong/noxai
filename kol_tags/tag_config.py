...
tag_name_config_list = [
        ...
        {'zh-Hans': 'DIY', 'zh-Hant': 'DIY', 'en': 'DIY', 'ko': 'DIY', 'id': 83},
        ...
        {'zh-Hans': '数码产品', 'zh-Hant': '數碼產品', 'en': 'Consumer Electronic', 
            'ko': '전자제품', 'id': 301}, #Electronic Devices
