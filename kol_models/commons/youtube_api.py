...
pool_spider = redis.ConnectionPool(host='r-j6c4ywxr8378ad1dax.redis.rds.aliyuncs.com', 
        password='dhmi5xMPjjfidUx4', port=6379)
...
def get_youtube_video_topics(video_id):
    request_url = ('https://www.googleapis.com/youtube/v3/videos?id=%s&key=%s&part=topicDetails' 
            % (video_id, youtube_key))
    json_obj = request_youtube_api_obj(request_url)
